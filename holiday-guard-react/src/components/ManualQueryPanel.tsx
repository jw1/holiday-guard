            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                ...
                <div className="col-span-1">
                    <label htmlFor="schedule-select"
                           className="block text-sm font-medium text-gray-700">Schedule</label>
                    <select
                        id="schedule-select"
                ...
                <div className="col-span-1">
                    <label htmlFor="client-id" className="block text-sm font-medium text-gray-700">Client
                        Identifier</label>
                    <input
                        type="text"
                        id="client-id"
            ...
            {queryResult && (
                <div className="mt-4 p-4 bg-gray-50 rounded-md">
                    ...
                    <div className="flex items-center">
                        ...
                        <span
                            className={`px-3 py-1 inline-flex text-sm leading-5 font-semibold rounded-full ${queryResult.shouldRun ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
