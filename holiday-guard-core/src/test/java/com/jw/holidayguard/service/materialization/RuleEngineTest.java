...
class RuleEngineTest {
    ...
    void shouldGenerateDatesForWeekdaysOnlyRule() {
        ScheduleRules weekdaysRule = ScheduleRules.builder()
    ...
    void shouldThrowExceptionForUnsupportedRuleType() {
        ScheduleRules unsupportedRule = ScheduleRules.builder()
            .ruleType(ScheduleRules.RuleType.CRON_EXPRESSION)  // Not supported yet
            .build();
